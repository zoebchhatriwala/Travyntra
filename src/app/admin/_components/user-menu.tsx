    ...
    return (
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                <button className="flex items-center gap-2 pl-2 pr-1 py-1 hover:bg-gray-50 rounded-corner-md transition-colors group">
            ...
            <DropdownMenuContent align="end" className="w-56 rounded-2xl p-2 shadow-xl border-gray-100">
                <DropdownMenuItem asChild className="rounded-corner-md focus:bg-indigo-50 cursor-pointer">
                ...
                <DropdownMenuItem
                    ...
                    className="rounded-corner-md text-red-600 focus:text-red-600 focus:bg-red-50 cursor-pointer"
                >
