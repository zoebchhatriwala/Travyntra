...
export function SettingsForm({ company }: SettingsFormProps) {
    ...
    const tabs = [
        { id: "organization", label: "Agency Profile", icon: Building2 },
    ...
    return (
        <form onSubmit={handleSubmit} className="flex flex-col lg:flex-row gap-8 relative min-h-[calc(100vh-200px)] pb-12">
            {/* Sidebar Navigation */}
