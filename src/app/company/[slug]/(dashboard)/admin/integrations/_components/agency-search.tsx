        ...
        <div className="space-y-6">
            ...
            {!isLoading && results.length > 0 && (
                <div className="grid gap-4 md:grid-cols-2">
                    {results.map((agency) => (
                        <div key={agency.id} className="bg-white rounded-corner-md border border-gray-100 p-4 shadow-sm hover:shadow-md transition-all flex items-center justify-between group flex-wrap gap-2 justify-center">
